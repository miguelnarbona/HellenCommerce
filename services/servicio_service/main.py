...
async def lifespan(app: FastAPI):
    global servicio_model, builder
    await log_to_logging_service("INFO", "Iniciando Servicio Microservice", line_num=43)
    ...
    await log_to_logging_service("INFO", f"SERVICIO Service iniciado. Delegará inferencia a {MODEL_UP_URL}", line_num=0)
    ...
    try:
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=60.0) as client:
                ...
                model_path = os.getenv("SERVICIO_MODEL_PATH", "c:/HellenData/mistral/mistral-7b-instruct-v0.2.Q4_K_M/mistral-7b-instruct-v0.2.Q4_K_M.gguf")
                ...
                if resp.status_code == 200:
                    ...
                    partial_response = "Buscando servicios disponibles para ti."
        ...
        await log_to_logging_service("INFO", f"Proceso SERVICIO completado para {user_id}", line_num=105)
        return {"intent": "SERVICIO", "partial": partial_response}
        
    except Exception as e:
        await log_to_logging_service("ERROR", f"Error procesando SERVICIO para {user_id}: {e}", line_num=109)
