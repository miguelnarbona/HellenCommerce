...
class InfoExtractor:
    ...
    def __init__(self):
        self.keywords_buy = self._load_keywords(settings.Config.KEYWORDS_BUY)
        self.keywords_sell = self._load_keywords(settings.Config.KEYWORDS_SELL)
        self.keywords_ntfy = self._load_keywords(settings.Config.KEYWORDS_NTFY)
